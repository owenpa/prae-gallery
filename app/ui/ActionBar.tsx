...
export default function ActionBar ({ oneGalleryImage, setIndexProp, idx, imagename, previouslyLiked }: { oneGalleryImage: boolean, setIndexProp: ((prevIdx: number, newIdx: number, direction: string) => void) | undefined, idx: number, imagename: string, previouslyLiked: boolean }): JSX.Element {
  ...
  return (
    <div className='flex w-full flex-wrap justify-between max-w-80 h-10'>
